...
const libcimplot = joinpath(CImGuiPack_jll.artifact_dir, "bin", "ImPlot_dll")
...
mutable struct ImGuiWindowDockStyle
    Colors::NTuple{6, ImU32}
    ImGuiWindowDockStyle() = new()
end
...
struct ImGuiWindow
    ...
    DockIsActive::Cint
    DockTabIsVisible::Cint
    DockTabWantClose::Cint
    DockOrder::Cshort
...
struct ImGuiDockNode
    ...
    IsFocused::Cint
    HasCloseButton::Cint
    HasWindowMenuButton::Cint
    WantCloseAll::Cint
    WantLockSizeOnce::Cint
    WantMouseMove::Cint
    WantHiddenTabBarUpdate::Cint
    WantHiddenTabBarToggle::Cint
    MarkedForPosSizeWrite::Cint
end

mutable struct ImGuiDockRequest end

mutable struct ImGuiDockContext
    Nodes::ImGuiStorage
    Requests::ImVector_ImGuiDockRequest
    NodesSettings::ImVector_ImGuiDockNodeSettings
    WantFullRebuild::Cint
    ImGuiDockContext() = new()
end
...
mutable struct ImGuiWindowClass
    ClassId::ImGuiID
    ...
    DockingAlwaysTabBar::Cint
    DockingAllowUnclassed::Cint
    ImGuiWindowClass() = new()
end
...
struct ImGuiViewport
    ...
    PlatformRequestMove::Cint
    PlatformRequestResize::Cint
    PlatformRequestClose::Cint
end
...
mutable struct ImGuiPlatformIO
...
struct ImGuiIO
    ...
    ConfigDockingNoSplit::Cint
    ConfigDockingWithShift::Cint
    ConfigDockingAlwaysTabBar::Cint
    ConfigDockingTransparentPayload::Cint
    ConfigViewportsNoAutoMerge::Cint
    ConfigViewportsNoTaskBarIcon::Cint
    ConfigViewportsNoDecoration::Cint
    ConfigViewportsNoDefaultParent::Cint
...
mutable struct ImChunkStream_ImGuiTableSettings
    ...
    ImChunkStream_ImGuiTableSettings() = new()
end
...
mutable struct ImChunkStream_ImGuiWindowSettings
    ...
    ImChunkStream_ImGuiWindowSettings() = new()
end
...
mutable struct ImVector_ImFontAtlasCustomRect
    ...
    ImVector_ImFontAtlasCustomRect() = new()
end
...
mutable struct ImVector_ImGuiContextHook
    ...
    ImVector_ImGuiContextHook() = new()
end

mutable struct ImVector_ImGuiDockNodeSettings
    Size::Cint
    Capacity::Cint
    Data::Ptr{ImGuiDockNodeSettings}
    ImVector_ImGuiDockNodeSettings() = new()
end

mutable struct ImVector_ImGuiDockRequest
    Size::Cint
    Capacity::Cint
    Data::Ptr{ImGuiDockRequest}
    ImVector_ImGuiDockRequest() = new()
end
...
mutable struct ImVector_ImGuiOldColumnData
    ...
    ImVector_ImGuiOldColumnData() = new()
end
...
mutable struct ImVector_ImGuiPlatformMonitor
    Size::Cint
    Capacity::Cint
    Data::Ptr{ImGuiPlatformMonitor}
    ImVector_ImGuiPlatformMonitor() = new()
end
...
mutable struct ImVector_ImGuiSettingsHandler
    ...
    ImVector_ImGuiSettingsHandler() = new()
end
...
mutable struct ImVector_ImGuiShrinkWidthItem
    ...
    ImVector_ImGuiShrinkWidthItem() = new()
end
...
mutable struct ImVector_ImGuiViewportPtr
    Size::Cint
    Capacity::Cint
    Data::Ptr{Ptr{ImGuiViewport}}
    ImVector_ImGuiViewportPtr() = new()
end
...
mutable struct ImVector_ImGuiViewportPPtr
    ...
    ImVector_ImGuiViewportPPtr() = new()
end
...
mutable struct ImVector_ImWchar
    ...
    Capacity::Cint
    Data::Ptr{ImWchar}
    ImVector_ImWchar() = new()
end

mutable struct ImVector_const_charPtr
    Size::Cint
    Capacity::Cint
    Data::Ptr{Cstring}
    ImVector_const_charPtr() = new()
end
...
function igGetWindowDpiScale()
    ccall((:igGetWindowDpiScale, libcimplot), Cfloat, ())
end
...
function igGetWindowViewport()
    ccall((:igGetWindowViewport, libcimplot), Ptr{ImGuiViewport}, ())
end
...
function igSetNextWindowViewport(viewport_id)
    ccall((:igSetNextWindowViewport, libcimplot), Cvoid, (ImGuiID,), viewport_id)
end
...
function igDockSpace(id, size, flags, window_class)
    ccall((:igDockSpace, libcimplot), Cvoid, (ImGuiID, ImVec2, ImGuiDockNodeFlags, Ptr{ImGuiWindowClass}), id, size, flags, window_class)
end

function igDockSpaceOverViewport(viewport, flags, window_class)
    ccall((:igDockSpaceOverViewport, libcimplot), ImGuiID, (Ptr{ImGuiViewport}, ImGuiDockNodeFlags, Ptr{ImGuiWindowClass}), viewport, flags, window_class)
end

function igSetNextWindowDockID(dock_id, cond)
    ccall((:igSetNextWindowDockID, libcimplot), Cvoid, (ImGuiID, ImGuiCond), dock_id, cond)
end

function igSetNextWindowClass(window_class)
    ccall((:igSetNextWindowClass, libcimplot), Cvoid, (Ptr{ImGuiWindowClass},), window_class)
end

function igGetWindowDockID()
    ccall((:igGetWindowDockID, libcimplot), ImGuiID, ())
end

function igIsWindowDocked()
    ccall((:igIsWindowDocked, libcimplot), Cint, ())
end
...
function igGetPlatformIO()
    ccall((:igGetPlatformIO, libcimplot), Ptr{ImGuiPlatformIO}, ())
end

function igUpdatePlatformWindows()
    ccall((:igUpdatePlatformWindows, libcimplot), Cvoid, ())
end

function igRenderPlatformWindowsDefault(platform_render_arg, renderer_render_arg)
    ccall((:igRenderPlatformWindowsDefault, libcimplot), Cvoid, (Ptr{Cvoid}, Ptr{Cvoid}), platform_render_arg, renderer_render_arg)
end

function igDestroyPlatformWindows()
    ccall((:igDestroyPlatformWindows, libcimplot), Cvoid, ())
end

function igFindViewportByID(id)
    ccall((:igFindViewportByID, libcimplot), Ptr{ImGuiViewport}, (ImGuiID,), id)
end

function igFindViewportByPlatformHandle(platform_handle)
    ccall((:igFindViewportByPlatformHandle, libcimplot), Ptr{ImGuiViewport}, (Ptr{Cvoid},), platform_handle)
end
...
function ImGuiWindowClass_ImGuiWindowClass()
    ccall((:ImGuiWindowClass_ImGuiWindowClass, libcimplot), Ptr{ImGuiWindowClass}, ())
end

function ImGuiWindowClass_destroy(self)
    ccall((:ImGuiWindowClass_destroy, libcimplot), Cvoid, (Ptr{ImGuiWindowClass},), self)
end
...
function ImGuiPlatformIO_ImGuiPlatformIO()
    ccall((:ImGuiPlatformIO_ImGuiPlatformIO, libcimplot), Ptr{ImGuiPlatformIO}, ())
end

function ImGuiPlatformIO_destroy(self)
    ccall((:ImGuiPlatformIO_destroy, libcimplot), Cvoid, (Ptr{ImGuiPlatformIO},), self)
end

function ImGuiPlatformMonitor_ImGuiPlatformMonitor()
    ccall((:ImGuiPlatformMonitor_ImGuiPlatformMonitor, libcimplot), Ptr{ImGuiPlatformMonitor}, ())
end

function ImGuiPlatformMonitor_destroy(self)
    ccall((:ImGuiPlatformMonitor_destroy, libcimplot), Cvoid, (Ptr{ImGuiPlatformMonitor},), self)
end
...
function ImGuiDockNode_ImGuiDockNode(id)
    ccall((:ImGuiDockNode_ImGuiDockNode, libcimplot), Ptr{ImGuiDockNode}, (ImGuiID,), id)
end

function ImGuiDockNode_destroy(self)
    ccall((:ImGuiDockNode_destroy, libcimplot), Cvoid, (Ptr{ImGuiDockNode},), self)
end

function ImGuiDockNode_IsRootNode()
    ccall((:ImGuiDockNode_IsRootNode, libcimplot), Cint, ())
end

function ImGuiDockNode_IsDockSpace()
    ccall((:ImGuiDockNode_IsDockSpace, libcimplot), Cint, ())
end

function ImGuiDockNode_IsFloatingNode()
    ccall((:ImGuiDockNode_IsFloatingNode, libcimplot), Cint, ())
end

function ImGuiDockNode_IsCentralNode()
    ccall((:ImGuiDockNode_IsCentralNode, libcimplot), Cint, ())
end

function ImGuiDockNode_IsHiddenTabBar()
    ccall((:ImGuiDockNode_IsHiddenTabBar, libcimplot), Cint, ())
end

function ImGuiDockNode_IsNoTabBar()
    ccall((:ImGuiDockNode_IsNoTabBar, libcimplot), Cint, ())
end

function ImGuiDockNode_IsSplitNode()
    ccall((:ImGuiDockNode_IsSplitNode, libcimplot), Cint, ())
end

function ImGuiDockNode_IsLeafNode()
    ccall((:ImGuiDockNode_IsLeafNode, libcimplot), Cint, ())
end

function ImGuiDockNode_IsEmpty()
    ccall((:ImGuiDockNode_IsEmpty, libcimplot), Cint, ())
end

function ImGuiDockNode_GetMergedFlags(self)
    ccall((:ImGuiDockNode_GetMergedFlags, libcimplot), ImGuiDockNodeFlags, (Ptr{ImGuiDockNode},), self)
end

function ImGuiDockNode_Rect(pOut, self)
    ccall((:ImGuiDockNode_Rect, libcimplot), Cvoid, (Ptr{ImRect}, Ptr{ImGuiDockNode}), pOut, self)
end

function ImGuiDockContext_ImGuiDockContext()
    ccall((:ImGuiDockContext_ImGuiDockContext, libcimplot), Ptr{ImGuiDockContext}, ())
end

function ImGuiDockContext_destroy(self)
    ccall((:ImGuiDockContext_destroy, libcimplot), Cvoid, (Ptr{ImGuiDockContext},), self)
end
...
function ImGuiViewportP_ClearRequestFlags(self)
    ccall((:ImGuiViewportP_ClearRequestFlags, libcimplot), Cvoid, (Ptr{ImGuiViewportP},), self)
end
...
function igStartMouseMovingWindowOrNode(window, node, undock_floating_node)
    ccall((:igStartMouseMovingWindowOrNode, libcimplot), Cvoid, (Ptr{ImGuiWindow}, Ptr{ImGuiDockNode}, Cint), window, node, undock_floating_node)
end
...
function igTranslateWindowsInViewport(viewport, old_pos, new_pos)
    ccall((:igTranslateWindowsInViewport, libcimplot), Cvoid, (Ptr{ImGuiViewportP}, ImVec2, ImVec2), viewport, old_pos, new_pos)
end

function igScaleWindowsInViewport(viewport, scale)
    ccall((:igScaleWindowsInViewport, libcimplot), Cvoid, (Ptr{ImGuiViewportP}, Cfloat), viewport, scale)
end

function igDestroyPlatformWindow(viewport)
    ccall((:igDestroyPlatformWindow, libcimplot), Cvoid, (Ptr{ImGuiViewportP},), viewport)
end

function igGetViewportPlatformMonitor(viewport)
    ccall((:igGetViewportPlatformMonitor, libcimplot), Ptr{ImGuiPlatformMonitor}, (Ptr{ImGuiViewport},), viewport)
end
...
function igDockContextInitialize(ctx)
    ccall((:igDockContextInitialize, libcimplot), Cvoid, (Ptr{ImGuiContext},), ctx)
end

function igDockContextShutdown(ctx)
    ccall((:igDockContextShutdown, libcimplot), Cvoid, (Ptr{ImGuiContext},), ctx)
end

function igDockContextClearNodes(ctx, root_id, clear_settings_refs)
    ccall((:igDockContextClearNodes, libcimplot), Cvoid, (Ptr{ImGuiContext}, ImGuiID, Cint), ctx, root_id, clear_settings_refs)
end

function igDockContextRebuildNodes(ctx)
    ccall((:igDockContextRebuildNodes, libcimplot), Cvoid, (Ptr{ImGuiContext},), ctx)
end

function igDockContextNewFrameUpdateUndocking(ctx)
    ccall((:igDockContextNewFrameUpdateUndocking, libcimplot), Cvoid, (Ptr{ImGuiContext},), ctx)
end

function igDockContextNewFrameUpdateDocking(ctx)
    ccall((:igDockContextNewFrameUpdateDocking, libcimplot), Cvoid, (Ptr{ImGuiContext},), ctx)
end

function igDockContextGenNodeID(ctx)
    ccall((:igDockContextGenNodeID, libcimplot), ImGuiID, (Ptr{ImGuiContext},), ctx)
end

function igDockContextQueueDock(ctx, target, target_node, payload, split_dir, split_ratio, split_outer)
    ccall((:igDockContextQueueDock, libcimplot), Cvoid, (Ptr{ImGuiContext}, Ptr{ImGuiWindow}, Ptr{ImGuiDockNode}, Ptr{ImGuiWindow}, ImGuiDir, Cfloat, Cint), ctx, target, target_node, payload, split_dir, split_ratio, split_outer)
end

function igDockContextQueueUndockWindow(ctx, window)
    ccall((:igDockContextQueueUndockWindow, libcimplot), Cvoid, (Ptr{ImGuiContext}, Ptr{ImGuiWindow}), ctx, window)
end

function igDockContextQueueUndockNode(ctx, node)
    ccall((:igDockContextQueueUndockNode, libcimplot), Cvoid, (Ptr{ImGuiContext}, Ptr{ImGuiDockNode}), ctx, node)
end

function igDockContextCalcDropPosForDocking()
    ccall((:igDockContextCalcDropPosForDocking, libcimplot), Cint, ())
end

function igDockNodeBeginAmendTabBar()
    ccall((:igDockNodeBeginAmendTabBar, libcimplot), Cint, ())
end

function igDockNodeEndAmendTabBar()
    ccall((:igDockNodeEndAmendTabBar, libcimplot), Cvoid, ())
end

function igDockNodeGetRootNode(node)
    ccall((:igDockNodeGetRootNode, libcimplot), Ptr{ImGuiDockNode}, (Ptr{ImGuiDockNode},), node)
end

function igDockNodeGetDepth(node)
    ccall((:igDockNodeGetDepth, libcimplot), Cint, (Ptr{ImGuiDockNode},), node)
end

function igGetWindowDockNode()
    ccall((:igGetWindowDockNode, libcimplot), Ptr{ImGuiDockNode}, ())
end

function igGetWindowAlwaysWantOwnTabBar()
    ccall((:igGetWindowAlwaysWantOwnTabBar, libcimplot), Cint, ())
end

function igBeginDocked(window, p_open)
    ccall((:igBeginDocked, libcimplot), Cvoid, (Ptr{ImGuiWindow}, Ptr{Cint}), window, p_open)
end

function igBeginDockableDragDropSource(window)
    ccall((:igBeginDockableDragDropSource, libcimplot), Cvoid, (Ptr{ImGuiWindow},), window)
end

function igBeginDockableDragDropTarget(window)
    ccall((:igBeginDockableDragDropTarget, libcimplot), Cvoid, (Ptr{ImGuiWindow},), window)
end

function igSetWindowDock(window, dock_id, cond)
    ccall((:igSetWindowDock, libcimplot), Cvoid, (Ptr{ImGuiWindow}, ImGuiID, ImGuiCond), window, dock_id, cond)
end

function igDockBuilderDockWindow(window_name, node_id)
    ccall((:igDockBuilderDockWindow, libcimplot), Cvoid, (Cstring, ImGuiID), window_name, node_id)
end

function igDockBuilderGetNode(node_id)
    ccall((:igDockBuilderGetNode, libcimplot), Ptr{ImGuiDockNode}, (ImGuiID,), node_id)
end

function igDockBuilderGetCentralNode(node_id)
    ccall((:igDockBuilderGetCentralNode, libcimplot), Ptr{ImGuiDockNode}, (ImGuiID,), node_id)
end

function igDockBuilderAddNode(node_id, flags)
    ccall((:igDockBuilderAddNode, libcimplot), ImGuiID, (ImGuiID, ImGuiDockNodeFlags), node_id, flags)
end

function igDockBuilderRemoveNode(node_id)
    ccall((:igDockBuilderRemoveNode, libcimplot), Cvoid, (ImGuiID,), node_id)
end

function igDockBuilderRemoveNodeDockedWindows(node_id, clear_settings_refs)
    ccall((:igDockBuilderRemoveNodeDockedWindows, libcimplot), Cvoid, (ImGuiID, Cint), node_id, clear_settings_refs)
end

function igDockBuilderRemoveNodeChildNodes(node_id)
    ccall((:igDockBuilderRemoveNodeChildNodes, libcimplot), Cvoid, (ImGuiID,), node_id)
end

function igDockBuilderSetNodePos(node_id, pos)
    ccall((:igDockBuilderSetNodePos, libcimplot), Cvoid, (ImGuiID, ImVec2), node_id, pos)
end

function igDockBuilderSetNodeSize(node_id, size)
    ccall((:igDockBuilderSetNodeSize, libcimplot), Cvoid, (ImGuiID, ImVec2), node_id, size)
end

function igDockBuilderSplitNode(node_id, split_dir, size_ratio_for_node_at_dir, out_id_at_dir, out_id_at_opposite_dir)
    ccall((:igDockBuilderSplitNode, libcimplot), ImGuiID, (ImGuiID, ImGuiDir, Cfloat, Ptr{ImGuiID}, Ptr{ImGuiID}), node_id, split_dir, size_ratio_for_node_at_dir, out_id_at_dir, out_id_at_opposite_dir)
end

function igDockBuilderCopyDockSpace(src_dockspace_id, dst_dockspace_id, in_window_remap_pairs)
    ccall((:igDockBuilderCopyDockSpace, libcimplot), Cvoid, (ImGuiID, ImGuiID, Ptr{ImVector_const_charPtr}), src_dockspace_id, dst_dockspace_id, in_window_remap_pairs)
end

function igDockBuilderCopyNode(src_node_id, dst_node_id, out_node_remap_pairs)
    ccall((:igDockBuilderCopyNode, libcimplot), Cvoid, (ImGuiID, ImGuiID, Ptr{ImVector_ImGuiID}), src_node_id, dst_node_id, out_node_remap_pairs)
end

function igDockBuilderCopyWindowSettings(src_name, dst_name)
    ccall((:igDockBuilderCopyWindowSettings, libcimplot), Cvoid, (Cstring, Cstring), src_name, dst_name)
end

function igDockBuilderFinish(node_id)
    ccall((:igDockBuilderFinish, libcimplot), Cvoid, (ImGuiID,), node_id)
end
...
function igTabBarFindMostRecentlySelectedTabForActiveWindow(tab_bar)
    ccall((:igTabBarFindMostRecentlySelectedTabForActiveWindow, libcimplot), Ptr{ImGuiTabItem}, (Ptr{ImGuiTabBar},), tab_bar)
end

function igTabBarAddTab(tab_bar, tab_flags, window)
    ccall((:igTabBarAddTab, libcimplot), Cvoid, (Ptr{ImGuiTabBar}, ImGuiTabItemFlags, Ptr{ImGuiWindow}), tab_bar, tab_flags, window)
end
...
function igRenderArrowDockMenu(draw_list, p_min, sz, col)
    ccall((:igRenderArrowDockMenu, libcimplot), Cvoid, (Ptr{ImDrawList}, ImVec2, Cfloat, ImU32), draw_list, p_min, sz, col)
end
...
function igDebugNodeDockNode(node, label)
    ccall((:igDebugNodeDockNode, libcimplot), Cvoid, (Ptr{ImGuiDockNode}, Cstring), node, label)
end

function igDebugNodeDrawList(window, viewport, draw_list, label)
    ccall((:igDebugNodeDrawList, libcimplot), Cvoid, (Ptr{ImGuiWindow}, Ptr{ImGuiViewportP}, Ptr{ImDrawList}, Cstring), window, viewport, draw_list, label)
end
...
function PlotPieChart(label_ids, values::Union{AbstractArray{Cfloat}, Ref{Cfloat}, Ptr{Cfloat}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartFloatPtr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{Cfloat}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{Cdouble}, Ref{Cdouble}, Ptr{Cdouble}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartdoublePtr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{Cdouble}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImS8}, Ref{ImS8}, Ptr{ImS8}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartS8Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImS8}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImU8}, Ref{ImU8}, Ptr{ImU8}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartU8Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImU8}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImS16}, Ref{ImS16}, Ptr{ImS16}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartS16Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImS16}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImU16}, Ref{ImU16}, Ptr{ImU16}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartU16Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImU16}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImS32}, Ref{ImS32}, Ptr{ImS32}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartS32Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImS32}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImU32}, Ref{ImU32}, Ptr{ImU32}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartU32Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImU32}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImS64}, Ref{ImS64}, Ptr{ImS64}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartS64Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImS64}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end

function PlotPieChart(label_ids, values::Union{AbstractArray{ImU64}, Ref{ImU64}, Ptr{ImU64}}, count::Integer, x::Real, y::Real, radius::Real, normalize::Integer, label_fmt, angle0::Real)
    ccall((:ImPlot_PlotPieChartU64Ptr, libcimplot), Cvoid, (Ptr{Cstring}, Ptr{ImU64}, Cint, Cdouble, Cdouble, Cdouble, Cint, Cstring, Cdouble), label_ids, values, count, x, y, radius, normalize, label_fmt, angle0)
end
